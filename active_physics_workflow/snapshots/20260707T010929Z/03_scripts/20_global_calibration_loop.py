...
def main() -> int:
    ...
    mode.add_argument("--memory-rebuild", action="store_true", help="Rebuild v3 memory: truth snapshot, artifacts, transitions, relations, proposal history.")
    mode.add_argument("--memory-report", action="store_true", help="Write a human-readable v3 memory report.")
