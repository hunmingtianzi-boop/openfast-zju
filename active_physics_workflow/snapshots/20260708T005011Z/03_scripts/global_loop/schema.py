...
class ProposalHistoryEntry:
    ...
    candidate_intent: dict[str, Any] = field(default_factory=dict)
    created_at: str = ""
    updated_at: str = ""
...
class CandidateIntent:
    ...
    touched_parameters: list[str] = field(default_factory=list)
...
class LocalProposal:
    ...
    status: str = "proposed"
    candidate_intent: CandidateIntent | None = None
    created_at: str = ""
